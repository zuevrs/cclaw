...
describe("v8.74 — ethos prepended to every specialist dispatch envelope", () => {
  ...
  it("AC-2 — all 10 specialist prompts reference the ethos preamble (auto-prepended via dispatch envelope) — v8.75 added plan-design; v8.77 added investigator; v8.82 added plan-devex", () => {
    // The 10 specialists in the v8.62-collapsed-plus-v8.75-plan-design-plus-v8.77-investigator-plus-v8.82-plan-devex roster.
    const specialists = [
