...
| **Auto-trigger skills** | 27 skills (`triage-gate`, `plan-authoring`, `tdd-and-verification`, `review-discipline`, `design-quality-discipline`, `devex-quality-discipline`, `commit-hygiene`, `completion-discipline`, `pre-edit-investigation`, `qa-and-browser`, `debug-and-browser`, `ac-discipline`, `source-driven`, `summary-format`, `documentation-and-adrs`, `parallel-build`, `refinement`, `flow-resume`, `receiving-feedback`, `anti-slop`, `conversation-language`, `api-evolution`, `pre-flight-assumptions`, `slice-discipline`, `ambiguity-discipline`, `structured-status`, `investigation-discipline`). Auto-applied per stage. `design-quality-discipline` (v8.75) is shared by `plan-design` (plan stage) and `reviewer.design-quality` (review stage); `devex-quality-discipline` (v8.82) is shared by `plan-devex` and a future post-build reviewer `devex` axis; `investigation-discipline` (v8.77) wraps the investigator's read-only diagnostic discipline. |
...
- [`src/content/skills/`](src/content/skills/) — 27 auto-trigger skill bodies.
...
.cclaw/
  ...
  lib/
    ...
    skills/                 27 auto-trigger skill bodies
