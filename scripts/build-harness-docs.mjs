...
const distModulePath = path.join(root, "dist", "content", "harness-doc.js");
...
process.stdout.write(`Updated ${path.relative(root, docsOutputPath)} from dist/content/harness-doc.js\n`);
