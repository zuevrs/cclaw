...
- \`.cclaw/lib/research/\`, \`.cclaw/lib/recovery/\`, \`.cclaw/lib/examples/\` — removed entirely. Research and recovery shipped empty index files between and v8.53; removed the directories themselves (no agent code path ever read from them). Examples was removed in v8.44 (same rationale).
