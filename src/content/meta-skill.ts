...
export function usingCclawSkillMarkdown(): string {
  return `---
name: using-cclaw
description: "Routing brain for cclaw. Decide whether to start/resume a stage, answer directly, or use utility commands like /cc-learn and /cc-feature."
---
...
Task arrives
  ...
  └─ Workspace operation? -> /cc-feature, /cc-status, /cc-tdd-log, /cc-retro, /cc-rewind
\`\`\`
