...
Open this runbook only when the planner artifact declares \`topology: parallel-build\` with ≥2 slices AND \`acMode == strict\`. For sequential build, see \`.cclaw/lib/runbooks/build.md\`.
