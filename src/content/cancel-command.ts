...
3. Otherwise, perform the cancel runtime:
   ...
   - Write \`.cclaw/flows/cancelled/<slug>/cancel.md\` recording the cancel time, the user's reason (if provided), and the artifacts that were moved. (On \`legacy-artifacts: true\` the file is named \`manifest.md\` for back-compat.)
