/**
 * Shared cross-cutting anti-rationalization catalog (v8.49).
 *
...
export function renderAntiRationalizationsCatalog(): string {
  const header = `# cclaw shared anti-rationalization catalog (v8.49)`;
  const preface = [
    "Auto-generated by `cclaw install` from `src/content/anti-rationalizations.ts > SHARED_ANTI_RATIONALIZATIONS`. v8.49 consolidated cross-cutting rationalization rows that previously drifted across multiple specialist prompts and skill `.md` files into this single catalog.",
    "",
