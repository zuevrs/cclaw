...
export const TDD: StageSchemaV2Input = {
  ...
  artifactRules: {
    ...
    artifactValidation: [
      ...
      { section: "Assertion Correctness Notes", required: false, validationRule: "Recommended when new assertions are introduced: each assertion lists a plausible subtle bug it would miss and a strengthening action (or `Sufficient`)." },
