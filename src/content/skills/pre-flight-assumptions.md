...
trigger: reference doc only — the assumption surface moved to design Phase 0 / ac-author Phase 0 in v8.21
---
...
The composition rules for an assumptions list are unchanged — design Phase 0 / ac-author Phase 0 use the same playbook:
...
The interpretation-forks sub-step (when the prompt has multiple readings) also moved into design Phase 1 (Clarify) on large-risky and stays inside the design specialist's protocol; ac-author Phase 0 on small-medium can surface a fork inline ("I'm reading this as X — say so if you meant Y") and persist to `triage.interpretationForks`.
